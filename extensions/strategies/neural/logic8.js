...
module.exports = function(s, weights, cb) {
  ...
  if(veryLongEma + veryLongEmaChange > ultraLongEma + ultraLongEmaChange) {
    
    if(ultraLongEmaChange > 0.3) {
  ...
  if(upwardTrend) {
    // if(longEma + longEmaChange > veryLongEma + veryLongEmaChange) {
    //   s.signal = 'buy'
    // }
