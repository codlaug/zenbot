...
module.exports = function bollinger (s, key, length, source_key) {
  ...
  if (s.lookback.length > length) {
    ...
    if (key+'_upper' in s.period) return
    let data = []
    ...
    s.period[key+'_upper'] = simple_result.upperBound
    s.period[key+'_mid'] = simple_result.midBound
    s.period[key+'_lower'] = simple_result.lowerBound
  }
}
